...
| [claude-code-plugin-structure](stack/claude-code-plugin-structure_2026-04-14.md) | stack | 2026-04-14 | 2026-04-15 | high | `.claude-plugin/plugin.json` + root-level `commands/`, `skills/`, `hooks/`; skills unified with slash commands in 2026 |
| [claude-code-session-jsonl-format](stack/claude-code-session-jsonl-format_2026-04-14.md) | stack | 2026-04-14 | 2026-04-15 | medium | JSONL transcripts at `~/.claude/projects/<slug>/<uuid>.jsonl`; schema confirmed, exact directory layout needs on-disk verification at Phase 5 |
